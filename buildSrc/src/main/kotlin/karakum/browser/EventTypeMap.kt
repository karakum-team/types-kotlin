...
internal val EVENT_DATA = listOf(
    ...
    EventInfo("web.clipboard.ClipboardEvent", missed = true),
    EventInfo("dom.events.CompositionEvent", missed = true),
    EventInfo("dom.events.DragEvent", missed = true),
    EventInfo("dom.events.FocusEvent", missed = true),
    EventInfo("dom.events.KeyboardEvent", missed = true),
    EventInfo("dom.events.MouseEvent", missed = true),
    EventInfo("dom.events.TouchEvent", missed = true),
    EventInfo("dom.events.PointerEvent", missed = true),
    EventInfo("dom.events.TransitionEvent", missed = true),
    EventInfo("dom.events.UIEvent", missed = true),
    EventInfo("dom.events.WheelEvent", missed = true),
    ...
    EventInfo("dom.events.InputEvent", missed = true),
