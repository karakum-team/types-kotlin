...
private val MOUSE_BUTTON_CONSTANTS = listOf(
    ButtonConstant(name = "MAIN", value = 0, description = "Main button pressed, usually the left button or the un-initialized state"),
    ButtonConstant(name = "AUXILIARY", value = 1, description = "Auxiliary button pressed, usually the wheel button or the middle button (if present)"),
...
private val MOUSE_BUTTONS_CONSTANTS = listOf(
    ...
    ButtonConstant(name = "AUXILIARY", value = 4, description = "Auxiliary button (usually the mouse wheel button or middle button)"),
