...
internal val RAW_UNIONS = mapOf(
    ...
    "HasExpressionInitializer" to "VariableDeclaration | ParameterDeclaration | BindingElement | PropertyDeclaration | PropertyAssignment | EnumMember",
    "HasDecorators" to "ParameterDeclaration | PropertyDeclaration | MethodDeclaration | GetAccessorDeclaration | SetAccessorDeclaration | ClassExpression | ClassDeclaration",
    "HasModifiers" to "TypeParameterDeclaration | ParameterDeclaration | ConstructorTypeNode | PropertySignature | PropertyDeclaration | MethodSignature | MethodDeclaration | ConstructorDeclaration | GetAccessorDeclaration | SetAccessorDeclaration | IndexSignatureDeclaration | FunctionExpression | ArrowFunction | ClassExpression | VariableStatement | FunctionDeclaration | ClassDeclaration | InterfaceDeclaration | TypeAliasDeclaration | EnumDeclaration | ModuleDeclaration | ImportEqualsDeclaration | ImportDeclaration | ExportAssignment | ExportDeclaration",
    "Modifier" to "AbstractKeyword | AccessorKeyword | AsyncKeyword | ConstKeyword | DeclareKeyword | DefaultKeyword | ExportKeyword | InKeyword | PrivateKeyword | ProtectedKeyword | PublicKeyword | OutKeyword | OverrideKeyword | ReadonlyKeyword | StaticKeyword",
    "ModifierLike" to "Modifier | Decorator",
    ...
    "ClassMemberModifier" to "AccessibilityModifier | ReadonlyKeyword | StaticKeyword | AccessorKeyword",
    "EntityName" to "Identifier | QualifiedName",
    "PropertyName" to "Identifier | StringLiteral | NoSubstitutionTemplateLiteral | NumericLiteral | ComputedPropertyName | PrivateIdentifier",
    "MemberName" to "Identifier | PrivateIdentifier",
    "DeclarationName" to "PropertyName | JsxAttributeName | StringLiteralLike | ElementAccessExpression | BindingPattern | EntityNameExpression",
    ...
    "PropertyNameLiteral" to "Identifier | StringLiteralLike | NumericLiteral | JsxNamespacedName",
    ...
    "CallLikeExpression" to "CallExpression | NewExpression | TaggedTemplateExpression | Decorator | JsxOpeningLikeElement | InstanceofExpression",
    ...
    "JsxAttributeName" to "Identifier | JsxNamespacedName",
    "JsxTagNameExpression" to "Identifier | ThisExpression | JsxTagNamePropertyAccess | JsxNamespacedName",
    "JsxAttributeValue" to "StringLiteral | JsxExpression | JsxElement | JsxSelfClosingElement | JsxFragment",
    ...
    "ImportAttributeName" to "Identifier | StringLiteral",
    "NamedImportsOrExports" to "NamedImports | NamedExports",
    "ImportOrExportSpecifier" to "ImportSpecifier | ExportSpecifier",
    "TypeOnlyCompatibleAliasDeclaration" to "ImportClause | ImportEqualsDeclaration | NamespaceImport | ImportOrExportSpecifier | ExportDeclaration | NamespaceExport",
    "TypeOnlyAliasDeclaration" to "TypeOnlyImportDeclaration | TypeOnlyExportDeclaration",
    ...
    "Visitor" to "Node, TOut extends Node | undefined",
    ...
    "PropertySignature.parent" to "TypeLiteralNode | InterfaceDeclaration",
    ...
    "MethodSignature.parent" to "TypeLiteralNode | InterfaceDeclaration",
    ...
    "JsxTagNamePropertyAccess.expression" to "Identifier | ThisExpression | JsxTagNamePropertyAccess",
    ...
    "ImportAttributes.token" to "SyntaxKind.WithKeyword | SyntaxKind.AssertKeyword",
    "ImportAttributes.parent" to "ImportDeclaration | ExportDeclaration",
