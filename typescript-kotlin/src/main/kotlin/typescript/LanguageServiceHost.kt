...
external interface LanguageServiceHost : GetEffectiveTypeRootsHost {
    ...
    val getResolvedModuleWithFailedLookupLocationsFromCache: ((modulename: String, containingFile: String, resolutionMode: dynamic /* ModuleKind.CommonJS | ModuleKind.ESNext */) -> ResolvedModuleWithFailedLookupLocations?)?
    val resolveTypeReferenceDirectives: ((typeDirectiveNames: ReadonlyArray<String>, containingFile: String, redirectedReference: ResolvedProjectReference?, options: CompilerOptions) -> dynamic /* (ResolvedTypeReferenceDirective | undefined)[] */)?
