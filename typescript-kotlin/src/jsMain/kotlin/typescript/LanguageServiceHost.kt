...
external sealed interface LanguageServiceHost : GetEffectiveTypeRootsHost, MinimalResolutionCacheHost {
...
val readDirectory: ((path: String,
extensions: ReadonlyArray<String>?,
exclude: ReadonlyArray<String>?,
include: ReadonlyArray<String>?,
depth: Int?) -> ReadonlyArray<String>)?
override val realpath: ((path: String) -> String)?
fun  readFile(path: String,
encoding: String = definedExternally): String?
override fun fileExists(path: String): Boolean
val getTypeRootsVersion: (() -> Int)?
val getResolvedModuleWithFailedLookupLocationsFromCache: ((modulename: String,
containingFile: String,
resolutionMode: ResolutionMode?) -> ResolvedModuleWithFailedLookupLocations?)?
val resolveModuleNameLiterals: ((moduleLiterals: ReadonlyArray<StringLiteralLike>,
containingFile: String,
redirectedReference: ResolvedProjectReference?,
options: CompilerOptions,
containingSourceFile: SourceFile,
reusedNames: ReadonlyArray<StringLiteralLike>?) -> ReadonlyArray<ResolvedModuleWithFailedLookupLocations>)?
val resolveTypeReferenceDirectiveReferences: ((typeDirectiveReferences: ReadonlyArray<Any /* T (FileReference | string) */>,
containingFile: String,
redirectedReference: ResolvedProjectReference?,
options: CompilerOptions,
containingSourceFile: SourceFile?,
reusedNames: ReadonlyArray<Any /* T (FileReference | string) */>?) -> ReadonlyArray<ResolvedTypeReferenceDirectiveWithFailedLookupLocations>)?
