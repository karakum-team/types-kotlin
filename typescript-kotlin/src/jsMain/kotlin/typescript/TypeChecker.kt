...
external sealed interface TypeChecker {
fun  getTypeOfSymbolAtLocation(symbol: Symbol,
node: Node): Type
...
fun  getPropertyOfType(type: Type,
propertyName: String): Symbol?
fun  getPrivateIdentifierPropertyOfType(leftType: Type,
name: String,
location: Node): Symbol?
fun  getIndexInfoOfType(type: Type,
kind: IndexKind): IndexInfo?
...
fun  getSignaturesOfType(type: Type,
kind: SignatureKind): ReadonlyArray<Signature>
fun  getIndexTypeOfType(type: Type,
kind: IndexKind): Type?
...
fun  typeToTypeNode(type: Type,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): TypeNode?
/** Note that the resulting nodes cannot be checked. */
fun  signatureToSignatureDeclaration(signature: Signature,
kind: SyntaxKind,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): SignatureDeclaration /* SignatureDeclaration & { typeArguments?: NodeArray<TypeNode>; } */?
/** Note that the resulting nodes cannot be checked. */
fun  indexInfoToIndexSignatureDeclaration(indexInfo: IndexInfo,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): IndexSignatureDeclaration?
/** Note that the resulting nodes cannot be checked. */
fun  symbolToEntityName(symbol: Symbol,
meaning: SymbolFlags,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): EntityName?
/** Note that the resulting nodes cannot be checked. */
fun  symbolToExpression(symbol: Symbol,
meaning: SymbolFlags,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): Expression?
/** Note that the resulting nodes cannot be checked. */
fun  symbolToTypeParameterDeclarations(symbol: Symbol,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): NodeArray<TypeParameterDeclaration>?
/** Note that the resulting nodes cannot be checked. */
fun  symbolToParameterDeclaration(symbol: Symbol,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): ParameterDeclaration?
/** Note that the resulting nodes cannot be checked. */
fun  typeParameterToDeclaration(parameter: TypeParameter,
enclosingDeclaration: Node?,
flags: NodeBuilderFlags?): TypeParameterDeclaration?
fun  getSymbolsInScope(location: Node,
meaning: SymbolFlags): ReadonlyArray<Symbol>
fun  getSymbolAtLocation(node: Node): Symbol?
fun  getSymbolsOfParameterPropertyDeclaration(parameter: ParameterDeclaration,
parameterName: String): ReadonlyArray<Symbol>
/**
...
fun  signatureToString(signature: Signature,
enclosingDeclaration: Node = definedExternally,
flags: TypeFormatFlags = definedExternally,
kind: SignatureKind = definedExternally): String
fun  typeToString(type: Type,
enclosingDeclaration: Node = definedExternally,
flags: TypeFormatFlags = definedExternally): String
fun  symbolToString(symbol: Symbol,
enclosingDeclaration: Node = definedExternally,
meaning: SymbolFlags = definedExternally,
flags: SymbolFormatFlags = definedExternally): String
fun  typePredicateToString(predicate: TypePredicate,
enclosingDeclaration: Node = definedExternally,
flags: TypeFormatFlags = definedExternally): String
...
fun  getSymbolOfExpando(node: Node,
allowDeclaration: Boolean): Symbol?
 ...
 */
fun  getResolvedSignature(node: CallLikeExpression,
candidatesOutArray: ReadonlyArray<Signature> = definedExternally,
argumentCount: Int = definedExternally): Signature?
...
fun  isValidPropertyAccess(node: dynamic /* PropertyAccessExpression | QualifiedName | ImportTypeNode */,
...
fun  tryGetMemberInModuleExports(memberName: String,
 ...
 * ```
 */
fun  isTypeAssignableTo(source: Type,
target: Type): Boolean
/**
...
fun  resolveName(name: String,
location: Node?,
meaning: SymbolFlags,
excludeGlobals: Boolean): Symbol?
 ...
 */
fun <T> runWithCancellationToken(token: CancellationToken,
cb: (checker: TypeChecker) -> T): T
}
