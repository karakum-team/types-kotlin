...
sealed interface ArrowFunction_: HasJSDoc, HasModifiers, SignatureDeclaration, FunctionLikeDeclaration, FlowStart_node
...
sealed interface BinaryExpression_: HasJSDoc, FlowArrayMutation_node

sealed interface BindingElement_: HasExpressionInitializer, VariableLikeDeclaration, ArrayBindingElement, ObjectBindingOrAssignmentElement, ObjectBindingPattern_parent, ArrayBindingPattern_parent, FlowAssignment_node
...
sealed interface ClassDeclaration_: HasDecorators, HasModifiers, ClassLikeDeclaration, ClassStaticBlockDeclaration_parent

sealed interface ClassExpression_: HasDecorators, HasModifiers, ClassLikeDeclaration, ClassStaticBlockDeclaration_parent

sealed interface ClassLikeDeclaration_: HasJSDoc, ObjectTypeDeclaration, DeclarationWithTypeParameterChildren, MethodDeclaration_parent, GetAccessorDeclaration_parent, SetAccessorDeclaration_parent, HeritageClause_parent
...
sealed interface ComputedPropertyName_: PropertyName
...
sealed interface ElementAccessExpression_: HasJSDoc, DeclarationName, BindingOrAssignmentElementTarget, AccessExpression
...
sealed interface ExportDeclaration_: HasJSDoc, HasModifiers, TypeOnlyCompatibleAliasDeclaration, ImportAttributes_parent
...
sealed interface FunctionExpression_: HasJSDoc, HasModifiers, SignatureDeclaration, FunctionLikeDeclaration, FlowStart_node
...
sealed interface GetAccessorDeclaration_: HasDecorators, HasModifiers, FunctionLikeDeclaration, AccessorDeclaration, FlowStart_node
...
sealed interface Identifier_: HasJSDoc, EntityName, PropertyName, MemberName, BindingName, PropertyNameLiteral, BindingOrAssignmentElementTarget, EntityNameExpression, JsxAttributeName, JsxTagNameExpression, ModuleName, JSDocNamespaceBody, ImportAttributeName, DeclarationStatement_name, TypePredicateNode_parameterName, JsxTagNamePropertyAccess_expression, JSDocTypedefTag_fullName, JSDocCallbackTag_fullName

sealed interface IdentifierTypePredicate_: TypePredicate

sealed interface IfStatement_: HasJSDoc

sealed interface ImportAttributes_parent: Node

sealed interface ImportAttributes_token

sealed interface ImportClause_: TypeOnlyCompatibleAliasDeclaration

sealed interface ImportDeclaration_: HasJSDoc, HasModifiers, ImportAttributes_parent
...
sealed interface InstanceofExpression_: CallLikeExpression

sealed interface InstantiableType_: IndexType_type

sealed interface InterfaceDeclaration_: HasJSDoc, HasModifiers, ObjectTypeDeclaration, DeclarationWithTypeParameterChildren, PropertySignature_parent, MethodSignature_parent, GetAccessorDeclaration_parent, SetAccessorDeclaration_parent, HeritageClause_parent
...
sealed interface JSDocSignature_: HasJSDoc, DeclarationWithTypeParameters, Signature_declaration
...
sealed interface JsxAttributeName_: DeclarationName
...
sealed interface JsxNamespacedName_: PropertyNameLiteral, JsxAttributeName, JsxTagNameExpression
...
sealed interface MethodDeclaration_: HasJSDoc, HasDecorators, HasModifiers, SignatureDeclaration, ObjectLiteralElementLike, FunctionLikeDeclaration, FlowStart_node
...
sealed interface MethodSignature_parent: Node
...
sealed interface ModuleKind_CommonJS: ResolutionMode

sealed interface ModuleKind_ESNext: ResolutionMode
...
sealed interface NamespaceExport_: NamedExportBindings, TypeOnlyCompatibleAliasDeclaration
...
sealed interface NoSubstitutionTemplateLiteral_: PropertyName, StringLiteralLike, LiteralToken, TemplateLiteralToken, TemplateLiteral

sealed interface NonNullChain_: OptionalChain

sealed interface NullLiteral_: JsonObjectExpression, LiteralTypeNode_literal

sealed interface NumericLiteral_: PropertyName, PropertyNameLiteral, LiteralToken, JsonObjectExpression, DeclarationStatement_name
...
sealed interface ObjectLiteralExpression_: HasJSDoc, ObjectBindingOrAssignmentPattern, AssignmentPattern, JsonObjectExpression, DestructuringPattern, MethodDeclaration_parent, GetAccessorDeclaration_parent, SetAccessorDeclaration_parent
...
sealed interface ParameterDeclaration_: HasJSDoc, HasType, HasExpressionInitializer, HasDecorators, HasModifiers, VariableLikeDeclaration, BindingOrAssignmentElement, ObjectBindingPattern_parent, ArrayBindingPattern_parent, SyntheticExpression_tupleNameSource
...
sealed interface PrivateIdentifier_: PropertyName, MemberName
...
sealed interface PropertyAccessExpression_: HasJSDoc, BindingOrAssignmentElementTarget, AccessExpression
...
sealed interface PropertyDeclaration_: HasJSDoc, HasType, HasExpressionInitializer, HasDecorators, HasModifiers, VariableLikeDeclaration

sealed interface PropertyName_: DeclarationName

sealed interface PropertySignature_: HasJSDoc, HasType, HasModifiers, VariableLikeDeclaration

sealed interface PropertySignature_parent: Node
...
sealed interface SemicolonClassElement_: HasJSDoc

sealed interface SetAccessorDeclaration_: HasDecorators, HasModifiers, FunctionLikeDeclaration, AccessorDeclaration, FlowStart_node
...
sealed interface StringLiteral_: PropertyName, StringLiteralLike, LiteralToken, JsxAttributeValue, ModuleName, ImportAttributeName, JsonObjectExpression, DeclarationStatement_name
...
sealed interface SyntaxKind_AmpersandAmpersandEqualsToken: PunctuationSyntaxKind, CompoundAssignmentOperator, LogicalOrCoalescingAssignmentOperator
...
sealed interface SyntaxKind_AssertKeyword: KeywordSyntaxKind, ImportAttributes_token
...
sealed interface SyntaxKind_BarBarEqualsToken: PunctuationSyntaxKind, CompoundAssignmentOperator, LogicalOrCoalescingAssignmentOperator
...
sealed interface SyntaxKind_QuestionQuestionEqualsToken: PunctuationSyntaxKind, CompoundAssignmentOperator, LogicalOrCoalescingAssignmentOperator
...
sealed interface SyntaxKind_UsingKeyword: KeywordSyntaxKind
...
sealed interface SyntaxKind_WithKeyword: KeywordSyntaxKind, ImportAttributes_token
...
sealed interface ThisExpression_: JsxTagNameExpression, JsxTagNamePropertyAccess_expression
...
sealed interface TypeLiteralNode_: ObjectTypeDeclaration, PropertySignature_parent, MethodSignature_parent, GetAccessorDeclaration_parent, SetAccessorDeclaration_parent

sealed interface TypeOnlyExportDeclaration_: TypeOnlyAliasDeclaration

sealed interface TypeOnlyImportDeclaration_: TypeOnlyAliasDeclaration
...
sealed interface TypeParameterDeclaration_: HasJSDoc, HasModifiers
...
sealed interface VariableDeclaration_: HasJSDoc, HasType, HasExpressionInitializer, VariableLikeDeclaration, BindingOrAssignmentElement, ObjectBindingPattern_parent, ArrayBindingPattern_parent, FlowAssignment_node
