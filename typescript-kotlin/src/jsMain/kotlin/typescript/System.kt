...
external sealed interface System {
 ...
 */
val watchFile: ((path: String,
callback: FileWatcherCallback,
pollingInterval: Int?,
options: WatchOptions?) -> FileWatcher)?
val watchDirectory: ((path: String,
...
depth: Int = definedExternally): ReadonlyArray<String>
val getModifiedTime: ((path: String) -> kotlin.js.Date?)?
val setModifiedTime: ((path: String,
time: kotlin.js.Date) -> Unit)?
...
val setTimeout: ((callback: Function<Unit>,
ms: Int,
/* vararg */ args: dynamic) -> Any)?
