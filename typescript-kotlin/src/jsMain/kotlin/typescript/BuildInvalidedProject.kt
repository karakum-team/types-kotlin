...
external sealed interface BuildInvalidedProject<T : BuilderProgram> : InvalidatedProjectBase {
...
cancellationToken: CancellationToken = definedExternally): ReadonlyArray<Diagnostic>
fun  getSemanticDiagnosticsOfNextAffectedFile(cancellationToken: CancellationToken = definedExternally,
ignoreSourceFile: (sourceFile: SourceFile) -> Boolean = definedExternally): AffectedFileResult<ReadonlyArray<Diagnostic>>
