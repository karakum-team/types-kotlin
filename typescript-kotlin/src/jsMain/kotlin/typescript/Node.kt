...
external sealed interface Node : ReadonlyTextRange {
val kind: SyntaxKind
val flags: NodeFlags
val parent: Node
...
sourceFile: SourceFile = definedExternally): Node
fun  getChildren(sourceFile: SourceFile = definedExternally): ReadonlyArray<Node>
fun  getStart(sourceFile: SourceFile = definedExternally,
includeJsDocComment: Boolean = definedExternally): Int
...
fun <T> forEachChild(cbNode: (node: Node) -> T?,
cbNodeArray: (nodes: NodeArray<Node>) -> T? = definedExternally): T?
}
