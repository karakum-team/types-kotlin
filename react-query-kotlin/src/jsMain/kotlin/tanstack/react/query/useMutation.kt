...
external fun <TData, TError, TVariables, TContext> useMutation(options: UseMutationOptions<TData, TError, TVariables, TContext> ,
queryClient: QueryClient  = definedExternally): UseMutationResult<TData, TError, TVariables, TContext>