...
external fun <TQueryFnData, TError, TData, TQueryData, TQueryKey: QueryKey> useBaseQuery(options: UseBaseQueryOptions<TQueryFnData, TError, TData, TQueryData, TQueryKey> ,
Observer: JsClass<QueryObserver<*, *, *, *, *>> ,
queryClient: QueryClient  = definedExternally): QueryObserverResult<TData, TError>