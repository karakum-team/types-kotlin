...
external fun <TQueryFnData, TError, TData, TQueryKey: QueryKey, TPageParam> useSuspenseInfiniteQuery(options: UseSuspenseInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey, TPageParam> ,
queryClient: QueryClient  = definedExternally): UseSuspenseInfiniteQueryResult<TData, TError>