...
external fun <TQueryFnData, TError, TData, TQueryKey: QueryKey> useQuery(options: UseQueryOptions<TQueryFnData, TError, TData, TQueryKey> ,
queryClient: QueryClient  = definedExternally): UseQueryResult<TData, TError>