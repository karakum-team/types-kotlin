...
external fun <TQueryFnData, TError, TData, TQueryKey: QueryKey> useSuspenseQuery(options: UseSuspenseQueryOptions<TQueryFnData, TError, TData, TQueryKey> ,
queryClient: QueryClient  = definedExternally): UseSuspenseQueryResult<TData, TError>