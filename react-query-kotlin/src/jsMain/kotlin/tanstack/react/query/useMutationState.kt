...
external fun <TResult> useMutationState(options: MutationStateOptions<TResult>  = definedExternally,
queryClient: QueryClient  = definedExternally): ReadonlyArray<TResult>