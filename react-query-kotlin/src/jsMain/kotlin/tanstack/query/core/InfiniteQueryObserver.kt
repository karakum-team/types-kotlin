...
open external class InfiniteQueryObserver <TQueryFnData, TError, TData, TQueryData, TQueryKey: QueryKey, TPageParam>(client: QueryClient ,
...
open protected var fetch: (fetchOptions: ObserverFetchOptions) -> Promise<InfiniteQueryObserverResult<TData, TError>>
override protected fun  bindMethods()
open fun  setOptions(options: InfiniteQueryObserverOptions<TQueryFnData, TError, TData, TQueryData, TQueryKey, TPageParam>  = definedExternally,
...
open protected fun  createResult(query: Query<TQueryFnData, TError, InfiniteData<TQueryData, TPageParam>, TQueryKey> ,
options: InfiniteQueryObserverOptions<TQueryFnData, TError, TData, TQueryData, TQueryKey, TPageParam> ): InfiniteQueryObserverResult<TData, TError>
}