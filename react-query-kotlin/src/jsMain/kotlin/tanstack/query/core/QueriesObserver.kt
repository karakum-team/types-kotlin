...
open external class QueriesObserver <TCombinedResult>(client: QueryClient ,
...
open fun  destroy()
open fun  setQueries(queries: ReadonlyArray<QueryObserverOptions<*, *, *, *, *, *>> ,
options: QueriesObserverOptions<TCombinedResult>  = definedExternally,
...
combine: CombineFn<TCombinedResult>? ): QueriesObserverOptimisticResult<TCombinedResult>
}
