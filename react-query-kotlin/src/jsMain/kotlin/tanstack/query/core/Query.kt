...
open fun  setData(newData: TData ,
options: SetDataOptions  = definedExternally): TData
...
open fun  invalidate()
open fun  fetch(options: QueryOptions<TQueryFnData, TError, TData, TQueryKey, *>  = definedExternally,
fetchOptions: FetchOptions  = definedExternally): Promise<TData>
}