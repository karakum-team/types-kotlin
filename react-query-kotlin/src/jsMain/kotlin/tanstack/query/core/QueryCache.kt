...
open fun <TQueryFnData, TError, TData, TQueryKey: QueryKey> build(client: QueryClient ,
options: QueryOptions<TQueryFnData, TError, TData, TQueryKey, *> ,
state: QueryState<TData, TError>  = definedExternally): Query<TQueryFnData, TError, TData, TQueryKey>
