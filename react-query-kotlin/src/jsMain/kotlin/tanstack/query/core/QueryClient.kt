...
open fun <TQueryFnData> setQueryData(queryKey: QueryKey ,
updater: Updater<TQueryFnData?, TQueryFnData?> ,
options: SetDataOptions  = definedExternally): TQueryFnData?
open fun <TQueryFnData> setQueriesData(filters: QueryFilters ,
updater: Updater<TQueryFnData?, TQueryFnData?> ,
options: SetDataOptions  = definedExternally): ReadonlyArray<JsTuple2<QueryKey, TQueryFnData?>>
...
open fun  resetQueries(filters: QueryFilters  = definedExternally,
options: ResetOptions  = definedExternally): Promise<Unit>
open fun  cancelQueries(filters: QueryFilters  = definedExternally,
cancelOptions: CancelOptions  = definedExternally): Promise<Unit>
open fun  invalidateQueries(filters: InvalidateQueryFilters  = definedExternally,
options: InvalidateOptions  = definedExternally): Promise<Unit>
open fun  refetchQueries(filters: RefetchQueryFilters  = definedExternally,
options: RefetchOptions  = definedExternally): Promise<Unit>
