...
open external class QueryObserver <TQueryFnData, TError, TData, TQueryData, TQueryKey: QueryKey>(client: QueryClient ,
...
open protected fun  bindMethods()
...
open fun  destroy()
open fun  setOptions(options: QueryObserverOptions<TQueryFnData, TError, TData, TQueryData, TQueryKey, *>  = definedExternally,
...
open protected fun  fetch(fetchOptions: ObserverFetchOptions ): Promise<QueryObserverResult<TData, TError>>
open protected fun  createResult(query: Query<TQueryFnData, TError, TQueryData, TQueryKey> ,
options: QueryObserverOptions<TQueryFnData, TError, TData, TQueryData, TQueryKey, *> ): QueryObserverResult<TData, TError>
