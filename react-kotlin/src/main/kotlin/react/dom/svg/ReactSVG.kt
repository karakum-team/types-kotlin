...
object ReactSVG {
    ...
    inline val defs: IntrinsicType<SVGAttributes<SVGDefsElement>>
        get() = IntrinsicType("defs")

    inline val desc: IntrinsicType<SVGAttributes<SVGDescElement>>
    ...
    inline val g: IntrinsicType<SVGAttributes<SVGGElement>>
        get() = IntrinsicType("g")

    inline val image: IntrinsicType<SVGAttributes<SVGImageElement>>
        get() = IntrinsicType("image")

    inline val line: IntrinsicType<SVGAttributes<SVGLineElement>>
        get() = IntrinsicType("line")

    inline val linearGradient: IntrinsicType<SVGAttributes<SVGLinearGradientElement>>
        get() = IntrinsicType("linearGradient")

    inline val marker: IntrinsicType<SVGAttributes<SVGMarkerElement>>
        get() = IntrinsicType("marker")

    inline val mask: IntrinsicType<SVGAttributes<SVGMaskElement>>
        get() = IntrinsicType("mask")

    inline val metadata: IntrinsicType<SVGAttributes<SVGMetadataElement>>
        get() = IntrinsicType("metadata")

    inline val mpath: IntrinsicType<SVGAttributes<SVGElement>>
        get() = IntrinsicType("mpath")

    inline val path: IntrinsicType<SVGAttributes<SVGPathElement>>
        get() = IntrinsicType("path")

    inline val pattern: IntrinsicType<SVGAttributes<SVGPatternElement>>
        get() = IntrinsicType("pattern")

    inline val polygon: IntrinsicType<SVGAttributes<SVGPolygonElement>>
        get() = IntrinsicType("polygon")

    inline val polyline: IntrinsicType<SVGAttributes<SVGPolylineElement>>
        get() = IntrinsicType("polyline")

    inline val radialGradient: IntrinsicType<SVGAttributes<SVGRadialGradientElement>>
    ...
    inline val switch: IntrinsicType<SVGAttributes<SVGSwitchElement>>
        get() = IntrinsicType("switch")

    inline val symbol: IntrinsicType<SVGAttributes<SVGSymbolElement>>
        get() = IntrinsicType("symbol")

    inline val text: IntrinsicType<SVGAttributes<SVGTextElement>>
        get() = IntrinsicType("text")

    inline val textPath: IntrinsicType<SVGAttributes<SVGTextPathElement>>
        get() = IntrinsicType("textPath")

    inline val tspan: IntrinsicType<SVGAttributes<SVGTSpanElement>>
        get() = IntrinsicType("tspan")

    inline val use: IntrinsicType<SVGAttributes<SVGUseElement>>
        get() = IntrinsicType("use")

    inline val view: IntrinsicType<SVGAttributes<SVGViewElement>>
